...
use crate::{
    ...
    task::{
        ...
        suspend_current_and_run_next, TaskStatus, curtask_syscall_times, into_pa,
        curtask_runtime,  curtask_any_mapped, curtask_any_unmapped, insert_curtask_framed_area, remove_curtask_framed_area,
...
pub fn sys_spawn(_path: *const u8) -> isize {
    ...
    if let Some(data) = get_app_data_by_name(path.as_str()){
        ...
        return cur_task.spawn(data) as isize;
    }else{
        return -1;
    }
}
